...
> - ex) $f_{\mathrm(clk)} = 84MHz$ 일때, PSC = 83이면  
>   - $f_{\mathrm(cnt)} = \frac{84MHz}{83 + 1} = 1MHz$ -> 카운터가 1us마다 1씩 증가한다.
...
> - ex) $f_{\mathrm(cnt)} = 1MHz$, ARR = 999이면  
>   - 0 ~ 999까지 1000번 카운트 -> 1000us = 1ms가 한 주기가 된다.
...
<img src="/assets/img/embedded/led/led_blink1.gif" width="400">
