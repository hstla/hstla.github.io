...
오토 박싱에 대해 공부하면서 궁금한 점이 있어 chatGPT에게`Integer n = new integer(10)` 와 `Integer n = 10;`의 차이점에 대해 물어보았다.
...
chatGPT가 맞는지도 모르고 잘 이해되지 않아 더블체크를 위해 Integer.balueOf()코드를 찾아보았다.
