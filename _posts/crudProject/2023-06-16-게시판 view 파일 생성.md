...
<span style="color:blue">bootstrap 홈페이지</span>
...
[<span style="color:blue">bootstrap 홈페이지</span>](https://getbootstrap.com/docs/5.3/getting-started/introduction/)의 docs에 있는 bootstrap css, js파일을 다운 받아 resources/templates폴더에 저장하여 사용하거나, 
...
내가 사용한 bootstrap 무료 템플릿 사이트 - [<span style="color:blue">bootstrap examples</span>](https://getbootstrap.com/docs/5.3/examples/), [<span style="color:blue">start bootstrap</span>](https://startbootstrap.com/themes)
...
결국 밑에 있던 bootstrap 없이 사용할 수 있는 라이트버전을 사용했다. [<span style="color:blue">summernote-lite</span>](https://summernote.org/getting-started/#without-bootstrap-lite)
